...
use oxide_auth::{
    ...
    endpoint::{
        Authorizer, Endpoint, Extension, OAuthError, OwnerConsent,
        OwnerSolicitor, QueryParameter, Scopes, Solicitation, Template,
        WebRequest,
    },
    ...
    fn handle(
        ...
        match ex {
            ...
            Extras::AuthPost(query_string) => {
                let solicitor = FnSolicitor(
                    move |_: &mut OAuthRequest, _: Solicitation| {
